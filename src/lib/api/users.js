...
export const modifyUserInfo = ({email,id,password,phone,birthday,name,comment,address,gender}) => axios.put("http://15.164.170.252:8080/api/auth",{email,id,password,phone,birthday,name,comment,address,gender},{withCredentials:true});
